...
public class Buku implements Serializable {
    ...
    @Column(name = "isbn", nullable = false, length = 2147483647)
    private String isbn;
    @Column(name = "judul_buku", length = 2147483647)
    private String judulBuku;
    @Column(name = "tahun_terbit", length = 2147483647)
    private String tahunTerbit;
    @Column(name = "penerbit", length = 2147483647)
